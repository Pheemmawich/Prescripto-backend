...
const appointmentComplete = async (req, res) => {
    try {
        ...
        //     { _id: appointmentId, docId, isCompleted: false },
        ...
        //   } else {
        //     return res.json({ success: false, message: "Appointment not found, already completed, or unauthorized" });
        //   }
...
const appointmentCancel = async (req, res) => {
    try {
        ...
        // const result = await appointmentModel.updateOne(
        //     { _id: appointmentId, docId, cancelled: false },
        //     { $set: { cancelled: true } }
        //   );
